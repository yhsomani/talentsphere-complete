...
import { Button, Badge, Card, CardContent, ShieldCheckIcon, GitBranchIcon, CodeIcon, LockIcon, ArrowRightIcon, CheckIcon } from '../components/ui/index.js';
    ...
    <div style={{ maxWidth: '1160px', margin: '0 auto', paddingBottom: spacing['3xl'] }}>
      ...
      >
        <div style={{ maxWidth: '840px' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', marginBottom: spacing.md }}>
          ...
          >
            ...
            projects, proctored code assessments, and an immutable evidence graph employers trust.
          </p>
          ...
          >
            ...
            >
              <div>
                ...
                <strong style={{ color: colors.neutral[800] }}>Staff Systems Architect (2.8 yrs)</strong>
              </div>
              <div>
                <span style={{ color: colors.neutral[500], display: 'block', marginBottom: '2px' }}>
              ...
              <div>
                ...
                <strong style={{ color: colors.neutral[800] }}>VP of Engineering &bull; 5/5 Scorecard</strong>
              </div>
              <div>
                <span style={{ color: colors.neutral[500], display: 'block', marginBottom: '2px' }}>
                  Provenance Hash
      ...
      <section style={{ paddingTop: spacing['2xl'], paddingBottom: spacing['2xl'] }}>
        <div style={{ marginBottom: spacing.xl }}>
          ...
          <p style={{ color: colors.neutral[600], fontSize: '1rem' }}>
            Built around strict cryptographic provenance, anti-fraud employment validation, and deterministic skills.
          </p>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: spacing.lg }}>
          <Card>
            <CardContent>
              ...
              <h3 style={{ fontSize: '1.125rem', fontWeight: 700, color: colors.neutral[900], marginBottom: spacing.xs }}>
                1. Talent Graph
              </h3>
              <p style={{ fontSize: '0.875rem', color: colors.neutral[600], lineHeight: 1.5, marginBottom: spacing.md }}>
                Maps verified competencies, prerequisite graphs, and transferability without reliance on keyword gaming,
                endorsement inflation, or self-reported LinkedIn claims.
              </p>
              <ul style={{ paddingLeft: '18px', margin: 0, fontSize: '0.8125rem', color: colors.neutral[700] }}>
          ...
          <Card>
            <CardContent>
              ...
              <p style={{ fontSize: '0.875rem', color: colors.neutral[600], lineHeight: 1.5, marginBottom: spacing.md }}>
                Immutable provenance backed by corporate email attestation, structured manager references, and reproducible code
                execution artifacts rather than static resume PDFs.
              </p>
              <ul style={{ paddingLeft: '18px', margin: 0, fontSize: '0.8125rem', color: colors.neutral[700] }}>
          ...
          <Card>
            <CardContent>
              ...
              <p style={{ fontSize: '0.875rem', color: colors.neutral[600], lineHeight: 1.5, marginBottom: spacing.md }}>
                Explainable opportunity matching with differential privacy small-cell suppression ($k \ge 10$) and zero AI compute
                costs billed silently to free candidates.
              </p>
              <ul style={{ paddingLeft: '18px', margin: 0, fontSize: '0.8125rem', color: colors.neutral[700] }}>
                <li style={{ marginBottom: '4px' }}>Deterministic matching algorithms</li>
                <li style={{ marginBottom: '4px' }}>Small-cell suppression against re-identification</li>
      ...
      >
        <div style={{ marginBottom: spacing.xl }}>
          ...
          <p style={{ color: colors.neutral[600], fontSize: '1rem' }}>
            A rigorous 3-stage validation process that creates trustworthy credentials without invasive surveillance.
          </p>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: spacing.lg }}>
          <div style={{ borderLeft: `3px solid ${colors.primary[600]}`, paddingLeft: spacing.md }}>
            <span style={{ fontSize: '0.8125rem', fontWeight: 700, color: colors.primary[700] }}>STEP 01</span>
            <h3 style={{ fontSize: '1.125rem', fontWeight: 700, color: colors.neutral[900], margin: `${spacing.xs} 0` }}>
              Attest Work History
            </h3>
            <p style={{ fontSize: '0.875rem', color: colors.neutral[600], lineHeight: 1.5 }}>
              Record employment entries with strict start/end date validation. Attest corporate email domain ownership
              via token verification.
            </p>
          </div>

          <div style={{ borderLeft: `3px solid ${colors.primary[600]}`, paddingLeft: spacing.md }}>
            <span style={{ fontSize: '0.8125rem', fontWeight: 700, color: colors.primary[700] }}>STEP 02</span>
            <h3 style={{ fontSize: '1.125rem', fontWeight: 700, color: colors.neutral[900], margin: `${spacing.xs} 0` }}>
              Structured Peer Endorsement
            </h3>
            <p style={{ fontSize: '0.875rem', color: colors.neutral[600], lineHeight: 1.5 }}>
              Request verified references from managers or senior peers. System verifies referee corporate email domain and enforces
              anti-collusion boundaries.
            </p>
          </div>

          <div style={{ borderLeft: `3px solid ${colors.semantic.success}`, paddingLeft: spacing.md }}>
            <span style={{ fontSize: '0.8125rem', fontWeight: 700, color: colors.semantic.success }}>STEP 03</span>
            <h3 style={{ fontSize: '1.125rem', fontWeight: 700, color: colors.neutral[900], margin: `${spacing.xs} 0` }}>
              Score &amp; Mint Badge
            </h3>
            <p style={{ fontSize: '0.875rem', color: colors.neutral[600], lineHeight: 1.5 }}>
              Deterministic scoring engine assigns a 0-100 confidence score and awards Bronze, Silver, or Gold verification tiers
              backed by cryptographic hash.
            </p>
          </div>
        </div>
